    ...
    public class ClienteController : ControllerBase
    {
        ...
        public IActionResult Get(int pular = 0, int pegar = 25)
        {
            try
            {
                ...
                var clientesViewModel = clientes.Select(e => new ClienteViewModel(e)).ToList();
        ...
        [HttpPut("{id}")]
        public IActionResult Put(int id, [FromBody] ClienteViewModel cliente)
        {
            try
            {
                if (!ModelState.IsValid)
                ...
                var clientExistente = _repositorio.ClienteExistente(id);
                ...
                {
                    var clienteModel = new Cliente(cliente) { Id = id };
